...
def differential_evolution(
    ...
    def step(state):
        ...
        crossover_mask = jnp.where(ensure_mutation_mask[:, None], crossover_mask, forced_mutation_mask) # merge masek z wymuszonym wyborem tylko tam, gdzie jest potrzebny
